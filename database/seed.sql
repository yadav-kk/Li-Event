...
-- 1. Create Centres (Delhi, Noida, Gurugram)
...
-- 2. Create Schools (using valid hex prefix "a1000000")
...
-- 3. Create Batches (using valid hex prefix "b1000000")
...
-- 4. Create Students (using valid hex prefixes "d1000000", "e1000000", "f1000000")
...
-- 6. Create Stages (using valid hex prefix "e1900000")
...
-- 7. Create Assessments for Stage 1 (ea900000)
...
-- 8. Create Assessment Criteria (ac900001)
-- Spelling Criteria
...
-- 9. Auto-Register students to the Event (APPROVED status)
